...
export default function Aurora({ colorStops = ['#ff4f00', '#151515', '#ff4f00'], amplitude = 1.0, blend = 0.5, speed = 1.0 }) {
  ...
  useEffect(() => {
    ...
    const update = t => {
      ...
      program.uniforms.uTime.value = t * 0.001 * propsRef.current.speed * 0.1;
